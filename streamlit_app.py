...
def screener():
    ...
    scr1['DevPR'] = scr1['DevPR'].astype(str)+ "%"
    scr1['OpMargin'] = scr1['OpMargin'].astype(str)+ "%"
    ...
    st.dataframe(scr1.style.highlight_max(axis=0),scr1.style.hide_index().format(subset=['mean'])
    st.subheader('Grafik')
    fig, ax = plt.subplots()
