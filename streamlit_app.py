...
def screener():
    screenlevel = option_menu(None, ['>Rp5rb','<Rp5rb','<Rp200','DevidenHunter'], icons=['house', 'file-earmark-text', 'sliders2-vertical', 'graph-up-arrow'], menu_icon="cast", default_index=0, orientation="horizontal")
