...
if fin.empty:
   ...
   dfringkas = {'date':date,'kode':kode,'skg':skg,'1ylo':lo,'6m':m,'1yhi':hi,'om':om,'cash(M)':int(cash),'opcash(M)':opcash,'dev':dev,'roe':roe,'pos':P,'eps':eps,'bv':bv,'pbv':pbv,'per':per,'vol':vol,'aksiy':aksiy,'aksik':aksik,'user':id}
