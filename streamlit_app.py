    ...
    with tab2:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
       ...
       if st.button('simpan'):
            ...
            brs.append({'date': date, 'kode': kodesaja, 'skg': C, 'p1': P1, 'p2': P2, 'p3': P3, 'vol': volbeli, 'aksiy': aksiy,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                        'aksik': aksik, 'total': total, 'user': id})                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
            n = pd.DataFrame(brs)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            dfaksi = pd.concat([dfaksi, n], ignore_index=True)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
            dfaksi.to_csv('aksi.csv', sep=";", index=False)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
            #df                                                                                                                                                                                                                                                                                                                                                                                                                                         
            st.write(f'Simulasi pembelian saham {namatampil} pada tanggal {date} sebanyak {volbeli} lembar berhasil disimpan. Total transaksi adalah Rp. {digit(round(total))},-')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
    with tab3:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
